...
blockmean faa.dat %i% %r1% -h1 -V > scratch
surface scratch -Ga.grd %i% %r1% -T0.3 -Lud -Lld -V -h1
makecpt -Cjet -T-300/250/50 -Z > a.cpt
grdview a.grd %s% %r% -Ca.cpt -Qi -X2 -Y7 -P -K -V -B1WNes  > %psfile%
...
pstext name.txt %r% %s% -O -V -K >> %psfile%
