...
blockmean Moho_Makran_2018_1deg.txt %i% %r1% -h1 -V > scratch
surface scratch -Gb.grd %i% %r1% -Lud -T0.3 -Lld -V -h1
makecpt -Cjet -T18/53/5 -Z > b.cpt
grdview b.grd %s% %r1% -Cb.cpt -Qi -X2 -Y7 -K -P -V > %psfile%
...
psscale %scalpos% -Cb.cpt -Ba5::/:km: -O -E -I >> %psfile%
