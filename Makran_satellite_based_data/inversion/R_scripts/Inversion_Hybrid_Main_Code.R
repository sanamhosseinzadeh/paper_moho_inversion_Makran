...
Wdir <- "C:/Users/90544/Documents/Makran_satellite_based_data/inversion/R_scripts"
...
syntheticfile = file.path(Hdir,"Makran_satellite_based_data/inversion/data/SatCBA.csv")

# define the path for the model file
modelfile = file.path(Hdir,"Makran_satellite_based_data/inversion/data/Model_Coordinates.csv")
