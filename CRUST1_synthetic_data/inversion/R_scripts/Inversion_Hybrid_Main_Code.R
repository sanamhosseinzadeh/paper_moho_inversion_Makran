...
Wdir <- "C:/Users/90544/Documents/CRUST1_synthetic_data/inversion/R_scripts"
...
syntheticfile = file.path(Hdir,"CRUST1_synthetic_data/inversion/data/CRUST1_NSynthetic_Data.csv")

# define the path for the Moho model file
modelfile = file.path(Hdir,"CRUST1_synthetic_data/inversion/data/CRUST1_Moho_Model.csv")
