...
syntheticfile <- "C:/Users/90544/Documents/CRUST1_synthetic_data/forward/data/CRUST1_Moho_Model.csv"
...
n <- rnorm(length(sBA$synthBA), mean = 0.0, sd = 5)
NBA <- sBA$synthBA + n #noisy
nsBA <- data.frame( long = xObs, lat = yObs, NsynthBA = NBA)

# Save results and define the path for the output file
write.table(nsBA, 
            file = "C:/Users/90544/Documents/CRUST1_synthetic_data/forward/results/CRUST1_NSynthetic_Data.csv",
