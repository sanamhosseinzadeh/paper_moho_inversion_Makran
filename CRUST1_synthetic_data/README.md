...
- `data/CRUST1_Moho_Model.csv`: Input file defining the CRUST1.0 Moho model.  
...
- `figures_GMT_scripts/figure5a_map_Simple_Moho_Model/a_map.bat`: GMT script to map the CRUST1.0 Moho model (Figure 5a).  
...
> **depth to Moho**  
>  Laske, G., Masters, G., Ma, Z. & Pasyanos, M. (2013), April. *Update on CRUST1. 0—A 1-degree global model of Earth’s crust*. In Geophysical research abstracts (Vol. 15, No. 15, p. 2658). https://igppweb.ucsd.edu/~gabi/crust1.html
---
